  ...
  var _$importsTable = _$table.DataTable({
    ...
    columnDefs: [
      ...
      <div class="d-flex justify-content-around">
          <button type="button" class="btn btn-sm btn-info detail-import" data-id="${row.id}" title="${l('Detail')}">
              <i class="fas fa-eye"></i>
          </button>
          <button type="button" class="btn btn-sm btn-secondary edit-import" data-id="${row.id}" title="${l('Edit')}">
