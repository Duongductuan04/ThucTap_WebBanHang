...
namespace SimpleTaskApp.Migrations
{
    ...
    [Migration("20251205080013_AddSupplierToImport")]
    partial class AddSupplierToImport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleTaskApp.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SimpleTaskApp.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SimpleTaskApp.MobilePhones.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("SimpleTaskApp.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("SimpleTaskApp.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SimpleTaskApp.Authorization.Roles.Role", b =>
                {
                    b.HasOne("SimpleTaskApp.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("SimpleTaskApp.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("SimpleTaskApp.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SimpleTaskApp.MobilePhones.OrderDetail", b =>
                {
                    ...
                    b.HasOne("SimpleTaskApp.MobilePhones.Order", "Order")
